...
function getSize() {
  if (window.innerWidth < window.innerHeight) return window.innerWidth - 150;else return 450;
}
...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function play(evt) {
      ...
      var c = { h: evt.pageX - canvas.offsetLeft, v: evt.pageY - canvas.offsetTop };
      ...
      if (c.h < canvas.width / 3 && c.v < canvas.height / 3 && !isThere(1)) game(1);else if (c.h > canvas.width / 3 && c.h < canvas.width / 3 * 2 && c.v < canvas.height / 3 && !isThere(2)) game(2);else if (c.h > canvas.width / 3 * 2 && c.h < canvas.width && c.v < canvas.height / 3 && !isThere(3)) game(3);else if (c.h < canvas.width / 3 && c.v > canvas.height / 3 && c.h < canvas.width / 3 * 2 && c.v < canvas.height / 3 * 2 && !isThere(4)) game(4);else if (c.h < canvas.width / 3 * 2 && c.h > canvas.width / 3 && c.v < canvas.height / 3 * 2 && c.v > canvas.height / 3 && !isThere(5)) game(5);else if (c.h < canvas.width && c.h > canvas.width / 3 * 2 && c.v > canvas.height / 3 && c.v < canvas.height / 3 * 2 && !isThere(6)) game(6);else if (c.h < canvas.width / 3 && c.v < canvas.height && c.v > canvas.height / 3 * 2 && !isThere(7)) game(7);else if (c.h < canvas.width / 3 * 2 && c.h > canvas.width / 3 && c.v < canvas.height && c.v > canvas.height / 3 * 2 && !isThere(8)) game(8);else if (c.h > canvas.width / 3 * 2 && c.h < canvas.width && c.v > canvas.height / 3 * 2 && c.v < canvas.height && !isThere(9)) game(9);
    }
  }, {
    key: "score",
    value: function score() {
      // to update the game score on navbar
...
var Draw = function () {
  ...
  _createClass(Draw, [{
    ...
    value: function o(squareNum) {
      if (!gameEnd) {
        // to prevent o execution if the user ( x ) win
...
function tictac() {
  ...
  if (tacIt(r1)) {
    ...
    var o = tacIt(r1);
    if (ticIt(r1, o, 1, 2)) new Draw().o(3);else if (ticIt(r1, o, 1, 3)) new Draw().o(2);else if (ticIt(r1, o, 2, 3)) new Draw().o(1);
  } else if (tacIt(r2)) {

    var _o = tacIt(r2);
    if (ticIt(r2, _o, 4, 5)) new Draw().o(6);else if (ticIt(r2, _o, 4, 6)) new Draw().o(5);else if (ticIt(r2, _o, 5, 6)) new Draw().o(4);
  } else if (tacIt(r3)) {

    var _o2 = tacIt(r3);
    if (ticIt(r3, _o2, 7, 8)) new Draw().o(9);else if (ticIt(r3, _o2, 7, 9)) new Draw().o(8);else if (ticIt(r3, _o2, 8, 9)) new Draw().o(7);
  } else if (tacIt(r4)) {

    var _o3 = tacIt(r4);
    if (ticIt(r4, _o3, 1, 4)) new Draw().o(7);else if (ticIt(r4, _o3, 1, 7)) new Draw().o(4);else if (ticIt(r4, _o3, 4, 7)) new Draw().o(1);
  } else if (tacIt(r5)) {

    var _o4 = tacIt(r5);
    if (ticIt(r5, _o4, 2, 5)) new Draw().o(8);else if (ticIt(r5, _o4, 2, 8)) new Draw().o(5);else if (ticIt(r5, _o4, 5, 8)) new Draw().o(2);
  } else if (tacIt(r6)) {

    var _o5 = tacIt(r6);
    if (ticIt(r6, _o5, 3, 6)) new Draw().o(9);else if (ticIt(r6, _o5, 3, 9)) new Draw().o(6);else if (ticIt(r6, _o5, 6, 9)) new Draw().o(3);
  } else if (tacIt(r7)) {

    var _o6 = tacIt(r7);
    if (ticIt(r7, _o6, 1, 5)) new Draw().o(9);else if (ticIt(r7, _o6, 1, 9)) new Draw().o(5);else if (ticIt(r7, _o6, 5, 9)) new Draw().o(1);
  } else if (tacIt(r8)) {

    var _o7 = tacIt(r8);
    if (ticIt(r8, _o7, 3, 5)) new Draw().o(7);else if (ticIt(r8, _o7, 3, 7)) new Draw().o(5);else if (ticIt(r8, _o7, 5, 7)) new Draw().o(3);
  } else {
    if (!isThere(5)) new Draw().o(5);else {
      (function () {
        var i = Math.floor(Math.random() * 8 + 1);
        if (!isThere(i) && squares.length !== 9 && squares.length < 10) new Draw().o(i);else {
...
function whoWon() {
  ...
  if (checkIt(r1)) winner(r1[0].con);else if (checkIt(r2)) winner(r2[0].con);else if (checkIt(r3)) winner(r3[0].con);else if (checkIt(r4)) winner(r4[0].con);else if (checkIt(r5)) winner(r5[0].con);else if (checkIt(r6)) winner(r6[0].con);else if (checkIt(r7)) winner(r7[0].con);else if (checkIt(r8)) winner(r8[0].con);else if (squares.length === 9) winner("draw");
  ...
  function winner(msg) {
    ...
    if (msg === "x") ++_score.x, ctx.fillText("Congrats you won! ( X )", canvas.width / 2, canvas.height / 2);else if (msg === "o") ++_score.o, ctx.fillText("Congrats you won! ( O )", canvas.width / 2, canvas.height / 2);else if (msg === "draw") ctx.fillText("No winner here!!", canvas.width / 2, canvas.height / 2);
