...
function whoWon() {
  ...
  function winner(msg) {
    ...
    if (msg === "x") ++score.x, ctx.fillText("Congrats you won! ( X )", canvas.width / 2, canvas.height / 2);else if (msg === "o") ++score.o, ctx.fillText("Oops, you lost! ( X )", canvas.width / 2, canvas.height / 2);else if (msg === "draw") ctx.fillText("No winner here!!", canvas.width / 2, canvas.height / 2);
    upScore();
    if (msg) {
      gameEnd = true;
      setTimeout(function () {
